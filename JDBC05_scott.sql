...
--5. 데이터(직원 정보) 입력 쿼리문
INSERT INTO TBL_EMP(EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_IT, TEL, BUSEO_IT, JIKWI_ID, BASICPAY, SUDANG)
VALUES (EMPSEQ.NEXTVAL, '이원영', '901212-1234567', TO_DATE('2010-11-11', 'YYYY-MM-DD')
...
--10. 직원 정보 수정 쿼리문 구성  
UPDATE TBL_EMP
SET EMP_NAME='이원일', SSN='801212-1234567'
...
WHERE EMP_ID = 1061;
--> 한 줄 구성
UPDATE TBL_EMP SET EMP_NAME='이원일', SSN='801212-1234567', IBSADATE=TO_DATE('2012-11-11', 'YYYY-MM-DD'), CITY_ID=(SELECT CITY_ID FROM TBL_CITY WHERE CITY_LOC ='제주'), TEL='010-9999-9999', BUSEO_ID=(SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '총무부'), JIKWI_ID=(SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '과장'), BASICPAY=5000000, SUDANG=1000000 WHERE EMP_ID = 1061
;
--==>>1 행 이(가) 업데이트되었습니다.
