...
SELECT * FROM TBL_MEMBER ORDER BY EMP_ID 
;

SELECT * FROM TBL_MEMBER WHERE EMP_NAME = '홍길동'
;

SELECT * FROM TBL_MEMBER WHERE BUSEO_ID = 1
;

SELECT * FROM TBL_MEMBER ORDER BY JIKWI_ID
;

SELECT * FROM TBL_MEMBER WHERE BASICPAY = 2610000 ORDER BY DESC
;

UPDATE TBL_MEMBER
SET NAME = '홍길동', SSN = '970506-1234567', IBSADATE = '2019-04-24', CITY_NAME = '부산'
, TEL = '010-9875-4561', BUSEO_NAME = '개발부', JIKWI_NAME = '대리'
, BASICPAY = 1250000, SUDANG = 2000000
WHERE EMP_ID = 1055
;

DELETE
FROM TBL_MEMBER M JOIN TBL_CITY C
